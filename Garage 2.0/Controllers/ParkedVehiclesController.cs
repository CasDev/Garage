...
namespace Garage.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        {
            var parkedVehicles = db.ParkedVehicles.Where(p => p.IsParked == false).ToList<ParkedVehicle>();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MemberId,VehicleId,ParkingTime,CheckoutTime,PricePerHour,IsParked,TotalPrice")] ParkedVehicle parkedVehicle)
        {
            if (ModelState.IsValid)
            {
